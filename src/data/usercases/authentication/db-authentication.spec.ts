...
describe('DbAuthentication UseCase', () => {
  ...
  test('Should thro if LoadAccountByEmailRepository throws', async () => {
    const { sut, loadAccountByEmailRepositoryStub } = makeSut()
  ...
  test('Should return null if LoadAccountByEmailRepository returns null', async () => {
    const { sut, loadAccountByEmailRepositoryStub } = makeSut()
    const loadSpy = jest.spyOn(loadAccountByEmailRepositoryStub, 'loadByEmail').mockReturnValueOnce(null)
  ...
  test('Should thro if HashComparer throws', async () => {
    const { sut, hashComparerStub } = makeSut()
